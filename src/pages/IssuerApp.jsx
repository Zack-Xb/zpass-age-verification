...
function IssuerApp() {
  ...
  const handleIssuerGenerateSignature = (values) => {
    ...
    // issuer account must be inputted or generated
    if (!account) {
    ...
    //parameters to form credential
    console.log({ subject, dob, nationality, expiry });

    // preparing message to be signed and hashed
    ...
    // returns signature (signed by issuer) and credential hash
